...
class PrompterPage(PlaybackMixin, MirrorSyncMixin, QWidget):
    ...
    def _on_mirror_fullscreen(self):
        ...
        if self._mirror_window.isFullScreen():
            self._mirror_window._resizing = True
        ...
        QTimer.singleShot(500, lambda: self._mirror_window._force_resize_to_aspect())
        if self._control_panel:
    ...
    def showEvent(self, event):
        ...
        if self._shortcut_mgr is None and self.window() is not None:
            ...
            self._shortcut_mgr.set_shortcuts({
                ...
                Qt.Key.Key_PageUp: self._start_scroll_up,
                Qt.Key.Key_PageDown: self._start_scroll_down,
            ...
            self._shortcut_mgr.set_release_shortcuts({
                ...
                Qt.Key.Key_PageUp: self._stop_scroll,
                Qt.Key.Key_PageDown: self._stop_scroll,
